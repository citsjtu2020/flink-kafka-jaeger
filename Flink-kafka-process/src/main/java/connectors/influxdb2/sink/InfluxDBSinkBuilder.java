 ...
 */
package connectors.influxdb2.sink;
import static connectors.influxdb2.sink.InfluxDBSinkOptions.*;
import static org.apache.flink.util.Preconditions.checkNotNull;

import org.apache.flink.configuration.Configuration;
import connectors.influxdb2.sink.writer.InfluxDBSchemaSerializer;
import connectors.influxdb2.sink.writer.InfluxDBWriter;
/**
...
public final class InfluxDBSinkBuilder<IN> {
     ...
     * Sets the InfluxDB organization name.
     *
     * @param version the version of the InfluxDB instance.
     * @return this InfluxDBSinkBuilder.
     */
    public InfluxDBSinkBuilder<IN> setInfluxDBVersion(final Integer version) {
        this.version = version;
        this.configuration.setInteger(INFLUXDB_VERSION, checkNotNull(version));
        return this;
    }
    ...
    /** Checks if the SchemaSerializer and the influxDBConfig are not null and set. */
     private void sanityCheck() {
        ...
        checkNotNull(this.version,"You should configure the version.");
    }
}
