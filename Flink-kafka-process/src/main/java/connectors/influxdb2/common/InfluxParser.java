package connectors.influxdb2.common;
...
public class InfluxParser {
    ...
    private static void parseTag(final InfluxLineProtocolParser.Tag_pairContext tag, final DataPoint out){
    ...
    private static void parseField(final InfluxLineProtocolParser.Field_pairContext field, final DataPoint out){
