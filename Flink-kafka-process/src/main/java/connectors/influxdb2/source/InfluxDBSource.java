 ...
 */
package connectors.influxdb2.source;

import java.util.function.Supplier;

import connectors.influxdb2.source.enumerator.InfluxDBSourceEnumStateSerializer;
import connectors.influxdb2.source.enumerator.InfluxDBSplitEnumerator;
import connectors.influxdb2.source.reader.InfluxDBRecordEmitter;
import connectors.influxdb2.source.reader.InfluxDBSourceReader;
import connectors.influxdb2.source.reader.InfluxDBSplitReader;
import connectors.influxdb2.source.reader.deserializer.InfluxDBDataPointDeserializer;
import connectors.influxdb2.source.split.InfluxDBSplitSerializer;
...
import connectors.influxdb2.source.enumerator.InfluxDBSourceEnumState;
/**
...
public final class InfluxDBSource<OUT> implements Source<OUT, InfluxDBSplit, InfluxDBSourceEnumState>, ResultTypeQueryable<OUT> {
    ...
    @Override
    public SourceReader<OUT, InfluxDBSplit> createReader(final SourceReaderContext sourceReaderContext){
