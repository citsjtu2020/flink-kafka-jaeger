...
public class AIOPSTraceProcessWindowFunction extends ProcessWindowFunction<Tuple9<String, String, String, String, Long, Long, String,String, String>,QPSs,String, TimeWindow> {
...
//        double p90dur = (double)DurList.get(tmp);
        ...
        System.out.println("QPS output: "+out.toString());
